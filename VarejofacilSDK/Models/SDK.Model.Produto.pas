...
type
  ...
  IProduto = interface(IModel)
    ...
    property MixId: Variant read GetMixId write SetMixId;
...
function TProduto.GetMixId: Variant;
begin
  Result := FMixId;
end;
...
procedure TProduto.SetMixId(const AMixId: Variant);
begin
  FMix := FMixId;
end;
...
function TProdutoListChanges.GetDataAlteracao: TDateTime;
begin
...
procedure TProdutoListChanges.SetDataAlteracao(const Value: TDateTime);
begin
